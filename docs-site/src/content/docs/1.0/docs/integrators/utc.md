...
1. Exchange a platform credential for a WIMSE JWT — [token exchange](/1.0/docs/integrators/token-exchange/).
2. Register the tool on the PEP (resource URI + allowed protocols) — [MCP security](/1.0/docs/integrators/mcp/) covers PEP-side registration.
...
- [MCP security](/1.0/docs/integrators/mcp/) — register and verify on the PEP
- [Exchange](/1.0/docs/concepts/exchange/) · [Revocation](/1.0/docs/concepts/revocation/) — fabric invariants
- [Documentation voice](/1.0/docs/voice/) — how these pages are written
