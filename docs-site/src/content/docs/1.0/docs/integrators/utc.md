...
1. Exchange a platform credential for a WIMSE JWT — [token exchange](/1.0/docs/token-exchange/).
2. Register the tool on the PEP (resource URI + allowed protocols) — [MCP security](/1.0/docs/mcp/) covers PEP-side registration.
...
- [MCP security](/1.0/docs/mcp/) — register and verify on the PEP
- [Exchange](/1.0/concepts/exchange/) · [Revocation](/1.0/concepts/revocation/) — fabric invariants
- [Documentation voice](/1.0/voice/) — how these pages are written
