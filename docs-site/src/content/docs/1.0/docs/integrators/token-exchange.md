...
- **`td`** — inbound trust plane ([trust domains](/1.0/concepts/trust-domains/))
...
**Agent identity** — `POST /v1/identity/agent` issues bootstrap tokens for registered agents. Dev mode accepts stub JWTs; see [getting started](/1.0/getting-started/).
...
→ [Credential patterns](/1.0/docs/credential-patterns/)

## Related

- [Credential patterns](/1.0/docs/credential-patterns/) — SPIFFE, K8s, Vault OIDC, cloud WI
- [MCP security](/1.0/docs/mcp/) — tool-scoped `audience`
- [Exchange concepts](/1.0/concepts/exchange/)
- [Revocation](/1.0/concepts/revocation/)
