...
slug: 1.0/docs/ecosystem/reasoner
---
...
- [How the fabric thinks](/1.0/docs/concepts/how-the-fabric-thinks/) — determinism vs probabilism, autonomic loop
- [CALM Forge](/1.0/docs/ecosystem/calm-forge/)
