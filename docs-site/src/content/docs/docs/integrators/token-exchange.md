...
→ [Credential patterns](/docs/credential-patterns/)

## Related

- [Credential patterns](/docs/credential-patterns/) — SPIFFE, K8s, Vault OIDC, cloud WI
- [MCP security](/docs/mcp/) — tool-scoped `audience`
