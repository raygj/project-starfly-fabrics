...
1. Exchange a platform credential for a WIMSE JWT — [token exchange](/docs/docs/integrators/token-exchange/).
2. Register the tool on the PEP (resource URI + allowed protocols) — [MCP security](/docs/docs/integrators/mcp/) covers PEP-side registration.
...
- [MCP security](/docs/docs/integrators/mcp/) — register and verify on the PEP
- [Exchange](/docs/docs/concepts/exchange/) · [Revocation](/docs/docs/concepts/revocation/) — fabric invariants
- [Documentation voice](/docs/docs/voice/) — how these pages are written
