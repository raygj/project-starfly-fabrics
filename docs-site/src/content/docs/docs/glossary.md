...
|------|------------------|
| [Trust domain](/docs/docs/glossary/#trust-domain) | Inbound identity plane (`td`) |
| [Audience](/docs/docs/glossary/#audience) | Outbound target (`aud`) |
| [Token exchange](/docs/docs/glossary/#token-exchange) | Credential in → WIMSE JWT out |
| [Revocation](/docs/docs/glossary/#revocation--kill-switch) | Immediate deny for compromised IDs |
| [PEP](/docs/docs/glossary/#pep-policy-enforcement-point) | Starfly at runtime |
| [UTC](/docs/docs/glossary/#utc-universal-tool-calling-layer) | One verifier, many protocols |
...
Deep dive: [trust domains](/docs/docs/glossary/concepts/trust-domains/).
...
- MCP binds `aud` to one tool; using it elsewhere is a [confused deputy](/docs/docs/glossary/integrators/mcp/).
...
Starfly **issues** WIMSE; SPIFFE SVIDs, K8s tokens, and IdP tokens are common **inputs** to exchange — not alternate WIMSE implementations. See [credential patterns](/docs/docs/glossary/integrators/credential-patterns/).

## Token exchange

RFC 8693 at `POST /v1/exchange/token`. Trade a platform credential (K8s SA, OIDC, SPIFFE, stub JWT in dev) for a WIMSE JWT.

Guide: [token exchange integrator](/docs/docs/glossary/integrators/token-exchange/) · Concepts: [exchange](/docs/docs/glossary/concepts/exchange/).
...
Concepts: [revocation](/docs/docs/glossary/concepts/revocation/) · Try: `./sandbox/run.sh revocation`
...
Guide: [MCP security](/docs/docs/glossary/integrators/mcp/) · Code: [`pkg/mcp/`](https://github.com/raygj/project-starfly-fabrics/tree/main/pkg/mcp)
...
Guide: [UTC](/docs/docs/glossary/integrators/utc/) · Code: [`pkg/toolcall/`](https://github.com/raygj/project-starfly-fabrics/tree/main/pkg/toolcall)
...
Guide: [Starfly Graph](/docs/docs/glossary/integrators/starfly-graph/)
...
- [Getting started](/docs/docs/glossary/getting-started/)
- [Documentation voice](/docs/docs/glossary/voice/)
