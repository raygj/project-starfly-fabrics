...
| **Explanation** | [Glossary](glossary.md) · [How the fabric thinks](concepts/how-the-fabric-thinks.md) · [Trust domains](concepts/trust-domains.md) · [Exchange](concepts/exchange.md) · [Revocation](concepts/revocation.md) · [Ecosystem](ecosystem/index.md) |
| **How-to** | [Token exchange](integrators/token-exchange.md) · [Vault PEP / PDP](integrators/vault-pep-pdp.md) · [Credential patterns](integrators/credential-patterns.md) · [MCP](integrators/mcp.md) · [UTC](integrators/utc.md) · [Dashboard](integrators/dashboard.md) · [Starfly Graph](integrators/starfly-graph.md) · [Sandbox](../sandbox/manifest.yaml) |
